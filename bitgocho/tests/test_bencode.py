...
class CodecTests(unittest.TestCase):
    def test_bencode(self):
        ...
        self.assertEqual(bencode(12345678901234567890), b"i12345678901234567890e")
        ...
        self.assertEqual(
            bencode([["Alice", "Bob"], [2, 3]]), b"ll5:Alice3:Bobeli2ei3eee"
        )
        self.assertEqual(bencode({}), b"de")
        self.assertEqual(
            bencode({"age": 25, "eyes": "blue"}), b"d3:agei25e4:eyes4:bluee"
        )
        self.assertEqual(
            bencode({"spam.mp3": {"author": "Alice", "length": 100000}}),
